...
interface BorderGlowProps {
  ...
  colors?: string[];
  fillOpacity?: number;
  /** Force light-surface blend modes (needed when bg is rgba / CSS vars) */
...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  const lightSurface = lightSurfaceProp ?? isLightColor(backgroundColor);
